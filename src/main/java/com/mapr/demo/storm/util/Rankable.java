...
public class Rankable implements Comparable<Rankable> {
    ...
    public Rankable(Object obj, long count, Object... otherFields) {
        if (obj == null) {
     ...
     * extracted and tracked, too. These fields can be accessed via {@link Rankable#getFields()}.
     *
    ...
    public static Rankable from(Tuple tuple) {
        ...
        return new Rankable(obj, count, otherFields.toArray());
    }
